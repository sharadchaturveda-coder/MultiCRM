...
// Mock data for the dashboard - in a real app, this would come from API
const revenueData = [
  ...
  if (!currentTenant) {
    return (
      <div className="p-8 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Welcome to MultiCRM</h2>
        <p className="text-gray-600 mb-6">Please select a tenant from the dropdown above to get started.</p>
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-md mx-auto">
          <p className="text-blue-700 text-sm">
            Tenants represent separate customer organizations. Each tenant has its own isolated data including contacts, deals, tasks, and invoices.
          </p>
        </div>
      </div>
    )
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="w-8 h-8 bg-primary-500 rounded-md flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M13 6H7l3 3v7h4v-9h3v9h4V9a2 2 0 00-2-2z" />
                  </svg>
                </div>
              </div>
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">$54,231</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">46</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Deal closed: $12,500</p>
